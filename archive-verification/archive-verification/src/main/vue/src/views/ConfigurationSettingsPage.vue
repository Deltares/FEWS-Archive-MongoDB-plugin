...
const createMutation = useMutation(gql`mutation createConfigurationSettings($toEmailAddresses: String!, $fromEmailAddress: String!, $drdlYamlPath: String!, $fewsRestApiUri: String!, $environment: String!, $threads: Int!, $cubeAdmins: String!, $cubeUsers: String!, $bimPath: String!, $databaseConnectionString: String!, $smtpServer: String!, $tabularConnectionString: String!,$drdlYamlServiceRestart: String!, $execute: Boolean!, $reprocessCubes: String!, $taskInterval: String!, $fewsArchiveDbAesPassword: String!, $fewsArchiveDbUsername: String!, $parallelPartitions: Int!, $drdlYamlConfigPath: String!, $fewsArchiveDbConnection: String!, $drdlYamlServiceRestartSuccess: String!, $dataStaleAfterSeconds: Int!) {createConfigurationSettings(toEmailAddresses: $toEmailAddresses, fromEmailAddress: $fromEmailAddress, drdlYamlPath: $drdlYamlPath, fewsRestApiUri: $fewsRestApiUri, environment: $environment, threads: $threads, cubeAdmins: $cubeAdmins, cubeUsers: $cubeUsers, bimPath: $bimPath, databaseConnectionString: $databaseConnectionString, smtpServer: $smtpServer, tabularConnectionString: $tabularConnectionString, drdlYamlServiceRestart: $drdlYamlServiceRestart, execute: $execute, reprocessCubes: $reprocessCubes, taskInterval: $taskInterval, fewsArchiveDbAesPassword: $fewsArchiveDbAesPassword, fewsArchiveDbUsername: $fewsArchiveDbUsername, parallelPartitions: $parallelPartitions, drdlYamlConfigPath: $drdlYamlConfigPath, fewsArchiveDbConnection: $fewsArchiveDbConnection, drdlYamlServiceRestartSuccess: $drdlYamlServiceRestartSuccess, dataStaleAfterSeconds: $dataStaleAfterSeconds)}`)
const updateMutation = useMutation(gql`mutation updateConfigurationSettings($_id: ID!, $toEmailAddresses: String!, $fromEmailAddress: String!, $drdlYamlPath: String!, $fewsRestApiUri: String!, $environment: String!, $threads: Int!, $cubeAdmins: String!, $cubeUsers: String!, $bimPath: String!, $databaseConnectionString: String!, $smtpServer: String!, $tabularConnectionString: String!,$drdlYamlServiceRestart: String!, $execute: Boolean!, $reprocessCubes: String!, $taskInterval: String!, $fewsArchiveDbAesPassword: String!, $fewsArchiveDbUsername: String!, $parallelPartitions: Int!, $drdlYamlConfigPath: String!, $fewsArchiveDbConnection: String!, $drdlYamlServiceRestartSuccess: String!, $dataStaleAfterSeconds: Int!) {updateConfigurationSettings(_id: $_id, toEmailAddresses: $toEmailAddresses, fromEmailAddress: $fromEmailAddress, drdlYamlPath: $drdlYamlPath, fewsRestApiUri: $fewsRestApiUri, environment: $environment, threads: $threads, cubeAdmins: $cubeAdmins, cubeUsers: $cubeUsers, bimPath: $bimPath, databaseConnectionString: $databaseConnectionString, smtpServer: $smtpServer, tabularConnectionString: $tabularConnectionString, drdlYamlServiceRestart: $drdlYamlServiceRestart, execute: $execute, reprocessCubes: $reprocessCubes, taskInterval: $taskInterval, fewsArchiveDbAesPassword: $fewsArchiveDbAesPassword, fewsArchiveDbUsername: $fewsArchiveDbUsername, parallelPartitions: $parallelPartitions, drdlYamlConfigPath: $drdlYamlConfigPath, fewsArchiveDbConnection: $fewsArchiveDbConnection, drdlYamlServiceRestartSuccess: $drdlYamlServiceRestartSuccess, dataStaleAfterSeconds: $dataStaleAfterSeconds)}`)
const deleteMutation = useMutation(gql`mutation deleteConfigurationSettings($_id: ID!) {deleteConfigurationSettings(_id: $_id)}`)

async function create() {
  const {toEmailAddresses, fromEmailAddress, drdlYamlPath, fewsRestApiUri, environment, threads, cubeAdmins, cubeUsers, bimPath, databaseConnectionString, smtpServer, tabularConnectionString, drdlYamlServiceRestart, execute, reprocessCubes, taskInterval, fewsArchiveDbAesPassword, fewsArchiveDbUsername, parallelPartitions, drdlYamlConfigPath, fewsArchiveDbConnection, drdlYamlServiceRestartSuccess, dataStaleAfterSeconds} = selected.value
