...
<div class="pa-4 pt-2">
  ...
  <div class="input">
    ...
    <div class="d-flex w-100 mt-2"><label for="i-smtpPort" class="border rounded-lg pa-2 input-label">smtpPort</label><input id="i-smtpPort" type="number" min="1024" max="65535" step="1" pattern="\d+" class="border rounded-lg pa-2 flex-grow-1 ml-2 input-data" v-model="selected.smtpPort"/></div>
