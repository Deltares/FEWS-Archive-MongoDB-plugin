...
const createMutation = useMutation(gql`mutation createConfigurationSettings($toEmailAddresses: String!, $fromEmailAddress: String!, $drdlYamlPath: String!, $environment: String!, $threads: Int!, $cubeAdmins: String!, $cubeUsers: String!, $bimPath: String!, $databaseConnectionString: String!, $smtpServer: String!, $tabularConnectionString: String!,$drdlYamlServiceRestart: String!, $execute: Boolean!, $archiveDb: String!, $taskInterval: String!, $databaseConnectionAesPassword: String!, $databaseConnectionUsername: String!, $parallelPartitions: Int!) {createConfigurationSettings(toEmailAddresses: $toEmailAddresses, fromEmailAddress: $fromEmailAddress, drdlYamlPath: $drdlYamlPath, environment: $environment, threads: $threads, cubeAdmins: $cubeAdmins, cubeUsers: $cubeUsers, bimPath: $bimPath, databaseConnectionString: $databaseConnectionString, smtpServer: $smtpServer, tabularConnectionString: $tabularConnectionString, drdlYamlServiceRestart: $drdlYamlServiceRestart, execute: $execute, archiveDb: $archiveDb, taskInterval: $taskInterval, databaseConnectionAesPassword: $databaseConnectionAesPassword, databaseConnectionUsername: $databaseConnectionUsername, parallelPartitions: $parallelPartitions)}`)
const updateMutation = useMutation(gql`mutation updateConfigurationSettings($_id: ID!, $toEmailAddresses: String!, $fromEmailAddress: String!, $drdlYamlPath: String!, $environment: String!, $threads: Int!, $cubeAdmins: String!, $cubeUsers: String!, $bimPath: String!, $databaseConnectionString: String!, $smtpServer: String!, $tabularConnectionString: String!,$drdlYamlServiceRestart: String!, $execute: Boolean!, $archiveDb: String!, $taskInterval: String!, $databaseConnectionAesPassword: String!, $databaseConnectionUsername: String!, $parallelPartitions: Int!) {updateConfigurationSettings(_id: $_id, toEmailAddresses: $toEmailAddresses, fromEmailAddress: $fromEmailAddress, drdlYamlPath: $drdlYamlPath, environment: $environment, threads: $threads, cubeAdmins: $cubeAdmins, cubeUsers: $cubeUsers, bimPath: $bimPath, databaseConnectionString: $databaseConnectionString, smtpServer: $smtpServer, tabularConnectionString: $tabularConnectionString, drdlYamlServiceRestart: $drdlYamlServiceRestart, execute: $execute, archiveDb: $archiveDb, taskInterval: $taskInterval, databaseConnectionAesPassword: $databaseConnectionAesPassword, databaseConnectionUsername: $databaseConnectionUsername, parallelPartitions: $parallelPartitions)}`)
const deleteMutation = useMutation(gql`mutation deleteConfigurationSettings($_id: ID!) {deleteConfigurationSettings(_id: $_id)}`)

async function create() {
  const {toEmailAddresses, fromEmailAddress, drdlYamlPath, environment, threads, cubeAdmins, cubeUsers, bimPath, databaseConnectionString, smtpServer, tabularConnectionString, drdlYamlServiceRestart, execute, archiveDb, taskInterval, databaseConnectionAesPassword, databaseConnectionUsername, parallelPartitions} = selected.value
...
<div class="pa-4 pt-2">
  ...
  <div class="input">
    ...
    <div class="d-flex w-100 mt-2"><label for="i-databaseConnectionAesPassword" class="border rounded-lg pa-2 input-label">databaseConnectionAesPassword</label><input id="i-databaseConnectionAesPassword" type="text" class="border rounded-lg pa-2 flex-grow-1 ml-2 input-data" v-model="selected.databaseConnectionAesPassword"/></div>
