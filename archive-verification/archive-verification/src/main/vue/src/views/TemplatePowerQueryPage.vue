...
async function run(mutation) {
  ...
  try {
    ...
    items.value = (await graphql(LIST)).templatePowerQueryN
  }
...
<div class="pa-4 pt-2">
  <div class="bg-blue-darken-2 rounded-lg text-center pa-1"><h3 class="ma-1">TemplatePowerQuery Editor</h3></div>
