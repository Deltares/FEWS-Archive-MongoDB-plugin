...
const createMutation = useMutation(gql`mutation createConfigurationDescription($name: String!, $toEmailAddresses: String!, $fromEmailAddress: String!, $drdlYamlPath: String!, $fewsRestApiUri: String!, $environment: String!, $cubeAdmins: String!, $cubeUsers: String!, $bimPath: String!, $databaseConnectionString: String!, $smtpServer: String!, $smtpPort: String!, $smtpUser: String!, $smtpPass: String!, $tabularConnectionString: String!, $execute: String!, $reprocessCubes: String!, $taskInterval: String!, $fewsArchiveDbAesPassword: String!, $fewsArchiveDbUsername: String!, $fewsArchiveDbConnection: String!, $dataStaleAfterSeconds: String!, $cubeParallelPartitions: String!, $cubeThreads: String!, $dataParallelPartitions: String!, $dataThreads: String!, $fewsVerificationDbAesPassword: String!, $fewsVerificationDbConnection: String!, $fewsVerificationDbUsername: String!, $parallel: String!, $processData: String!) {createConfigurationDescription(name: $name, toEmailAddresses: $toEmailAddresses, fromEmailAddress: $fromEmailAddress, drdlYamlPath: $drdlYamlPath, fewsRestApiUri: $fewsRestApiUri, environment: $environment, cubeAdmins: $cubeAdmins, cubeUsers: $cubeUsers, bimPath: $bimPath, databaseConnectionString: $databaseConnectionString, smtpServer: $smtpServer, smtpPort: $smtpPort, smtpUser: $smtpUser, smtpPass: $smtpPass, tabularConnectionString: $tabularConnectionString, execute: $execute, reprocessCubes: $reprocessCubes, taskInterval: $taskInterval, fewsArchiveDbAesPassword: $fewsArchiveDbAesPassword, fewsArchiveDbUsername: $fewsArchiveDbUsername, fewsArchiveDbConnection: $fewsArchiveDbConnection, dataStaleAfterSeconds: $dataStaleAfterSeconds, cubeParallelPartitions: $cubeParallelPartitions, cubeThreads: $cubeThreads, dataParallelPartitions: $dataParallelPartitions, dataThreads: $dataThreads, fewsVerificationDbAesPassword: $fewsVerificationDbAesPassword, fewsVerificationDbConnection: $fewsVerificationDbConnection, fewsVerificationDbUsername: $fewsVerificationDbUsername, parallel: $parallel, processData: $processData)}`)
const updateMutation = useMutation(gql`mutation updateConfigurationDescription($_id: ID!, $name: String!, $toEmailAddresses: String!, $fromEmailAddress: String!, $drdlYamlPath: String!, $fewsRestApiUri: String!, $environment: String!, $cubeAdmins: String!, $cubeUsers: String!, $bimPath: String!, $databaseConnectionString: String!, $smtpServer: String!, $smtpPort: String!, $smtpUser: String!, $smtpPass: String!, $tabularConnectionString: String!, $execute: String!, $reprocessCubes: String!, $taskInterval: String!, $fewsArchiveDbAesPassword: String!, $fewsArchiveDbUsername: String!, $fewsArchiveDbConnection: String!, $dataStaleAfterSeconds: String!, $cubeParallelPartitions: String!, $cubeThreads: String!, $dataParallelPartitions: String!, $dataThreads: String!, $fewsVerificationDbAesPassword: String!, $fewsVerificationDbConnection: String!, $fewsVerificationDbUsername: String!, $parallel: String!, $processData: String!) {updateConfigurationDescription(_id: $_id, name: $name, toEmailAddresses: $toEmailAddresses, fromEmailAddress: $fromEmailAddress, drdlYamlPath: $drdlYamlPath, fewsRestApiUri: $fewsRestApiUri, environment: $environment, cubeAdmins: $cubeAdmins, cubeUsers: $cubeUsers, bimPath: $bimPath, databaseConnectionString: $databaseConnectionString, smtpServer: $smtpServer, smtpPort: $smtpPort, smtpUser: $smtpUser, smtpPass: $smtpPass, tabularConnectionString: $tabularConnectionString, execute: $execute, reprocessCubes: $reprocessCubes, taskInterval: $taskInterval, fewsArchiveDbAesPassword: $fewsArchiveDbAesPassword, fewsArchiveDbUsername: $fewsArchiveDbUsername, fewsArchiveDbConnection: $fewsArchiveDbConnection, dataStaleAfterSeconds: $dataStaleAfterSeconds, cubeParallelPartitions: $cubeParallelPartitions, cubeThreads: $cubeThreads, dataParallelPartitions: $dataParallelPartitions, dataThreads: $dataThreads, fewsVerificationDbAesPassword: $fewsVerificationDbAesPassword, fewsVerificationDbConnection: $fewsVerificationDbConnection, fewsVerificationDbUsername: $fewsVerificationDbUsername, parallel: $parallel, processData: $processData)}`)
...
<div class="pa-4 pt-2">
  ...
  <div class="input">
    ...
    <div class="d-flex w-100 mt-2"><label for="i-smtpPort" class="border rounded-lg pa-2 input-label">smtpPort</label><input id="i-smtpPort" type="text" class="border rounded-lg pa-2 flex-grow-1 ml-2 input-data" v-model="selected.smtpPort"/></div>
    ...
    <div class="d-flex w-100 mt-2"><label for="i-dataStaleAfterSeconds" class="border rounded-lg pa-2 input-label">dataStaleAfterSeconds</label><input id="i-dataStaleAfterSeconds" type="text" class="border rounded-lg pa-2 flex-grow-1 ml-2 input-data" v-model="selected.dataStaleAfterSeconds"/></div>
    <div class="d-flex w-100 mt-2"><label for="i-cubeParallelPartitions" class="border rounded-lg pa-2 input-label">cubeParallelPartitions</label><input id="i-cubeParallelPartitions" type="text" class="border rounded-lg pa-2 flex-grow-1 ml-2 input-data" v-model="selected.cubeParallelPartitions"/></div>
    <div class="d-flex w-100 mt-2"><label for="i-cubeThreads" class="border rounded-lg pa-2 input-label">cubeThreads</label><input id="i-cubeThreads" type="text" class="border rounded-lg pa-2 flex-grow-1 ml-2 input-data" v-model="selected.cubeThreads"/></div>
    <div class="d-flex w-100 mt-2"><label for="i-dataParallelPartitions" class="border rounded-lg pa-2 input-label">dataParallelPartitions</label><input id="i-dataParallelPartitions" type="text" class="border rounded-lg pa-2 flex-grow-1 ml-2 input-data" v-model="selected.dataParallelPartitions"/></div>
    <div class="d-flex w-100 mt-2"><label for="i-dataThreads" class="border rounded-lg pa-2 input-label">dataThreads</label><input id="i-dataThreads" type="text" class="border rounded-lg pa-2 flex-grow-1 ml-2 input-data" v-model="selected.dataThreads"/></div>
    ...
    <div class="d-flex w-100 mt-2"><label for="i-parallel" class="border rounded-lg pa-2 input-label">parallel</label><input id="i-parallel" type="text" class="border rounded-lg pa-2 flex-grow-1 ml-2 input-data" v-model="selected.parallel"/></div>
    <div class="d-flex w-100 mt-2"><label for="i-processData" class="border rounded-lg pa-2 input-label">processData</label><input id="i-processData" type="text" class="border rounded-lg pa-2 flex-grow-1 ml-2 input-data" v-model="selected.processData"/></div>
  </div>
  <div class="mt-4">
