...
const createMutation = useMutation(gql`mutation createConfigurationDescription($name: String!, $toEmailAddresses: String!, $fromEmailAddress: String!, $drdlYamlPath: String!, $environment: String!, $threads: String!, $cubeAdmins: String!, $cubeUsers: String!, $bimPath: String!, $databaseConnectionString: String!, $smtpServer: String!, $tabularConnectionString: String!,$drdlYamlServiceRestart: String!, $execute: String!, $taskInterval: String!, $fewsArchiveDbAesPassword: String!, $fewsArchiveDbUsername: String!, $parallelPartitions: String!, $drdlYamlConfigPath: String!, $fewsArchiveDbConnection: String!, $refreshViews: String!) {createConfigurationDescription(name: $name, toEmailAddresses: $toEmailAddresses, fromEmailAddress: $fromEmailAddress, drdlYamlPath: $drdlYamlPath, environment: $environment, threads: $threads, cubeAdmins: $cubeAdmins, cubeUsers: $cubeUsers, bimPath: $bimPath, databaseConnectionString: $databaseConnectionString, smtpServer: $smtpServer, tabularConnectionString: $tabularConnectionString, drdlYamlServiceRestart: $drdlYamlServiceRestart, execute: $execute, taskInterval: $taskInterval, fewsArchiveDbAesPassword: $fewsArchiveDbAesPassword, fewsArchiveDbUsername: $fewsArchiveDbUsername, parallelPartitions: $parallelPartitions, drdlYamlConfigPath: $drdlYamlConfigPath, fewsArchiveDbConnection: $fewsArchiveDbConnection, refreshViews: $refreshViews)}`)
const updateMutation = useMutation(gql`mutation updateConfigurationDescription($_id: ID!, $name: String!, $toEmailAddresses: String!, $fromEmailAddress: String!, $drdlYamlPath: String!, $environment: String!, $threads: String!, $cubeAdmins: String!, $cubeUsers: String!, $bimPath: String!, $databaseConnectionString: String!, $smtpServer: String!, $tabularConnectionString: String!,$drdlYamlServiceRestart: String!, $execute: String!, $taskInterval: String!, $fewsArchiveDbAesPassword: String!, $fewsArchiveDbUsername: String!, $parallelPartitions: String!, $drdlYamlConfigPath: String!, $fewsArchiveDbConnection: String!, $refreshViews: String!) {updateConfigurationDescription(_id: $_id, name: $name, toEmailAddresses: $toEmailAddresses, fromEmailAddress: $fromEmailAddress, drdlYamlPath: $drdlYamlPath, environment: $environment, threads: $threads, cubeAdmins: $cubeAdmins, cubeUsers: $cubeUsers, bimPath: $bimPath, databaseConnectionString: $databaseConnectionString, smtpServer: $smtpServer, tabularConnectionString: $tabularConnectionString, drdlYamlServiceRestart: $drdlYamlServiceRestart, execute: $execute, taskInterval: $taskInterval, fewsArchiveDbAesPassword: $fewsArchiveDbAesPassword, fewsArchiveDbUsername: $fewsArchiveDbUsername, parallelPartitions: $parallelPartitions, drdlYamlConfigPath: $drdlYamlConfigPath, fewsArchiveDbConnection: $fewsArchiveDbConnection, refreshViews: $refreshViews)}`)
...
async function create() {
  const {Name, toEmailAddresses, fromEmailAddress, drdlYamlPath, environment, threads, cubeAdmins, cubeUsers, bimPath, databaseConnectionString, smtpServer, tabularConnectionString, drdlYamlServiceRestart, execute, taskInterval, fewsArchiveDbAesPassword, fewsArchiveDbUsername, parallelPartitions, drdlYamlConfigPath, fewsArchiveDbConnection, refreshViews} = selected.value
...
<div class="pa-4 pt-2">
  ...
  <div class="input">
    ...
    <div class="d-flex w-100 mt-2"><label for="i-refreshViews" class="border rounded-lg pa-2 input-label">refreshViews</label><input id="i-refreshViews" type="text" class="border rounded-lg pa-2 flex-grow-1 ml-2 input-data" v-model="selected.refreshViews"/></div>
  </div>
  <div class="mt-4">
