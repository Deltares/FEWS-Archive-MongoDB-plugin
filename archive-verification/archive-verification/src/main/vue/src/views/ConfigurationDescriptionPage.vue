...
const createMutation = useMutation(gql`mutation createConfigurationDescription($name: String!, $toEmailAddresses: String!, $fromEmailAddress: String!, $drdlYamlPath: String!, $environment: String!, $threads: String!, $cubeAdmins: String!, $cubeUsers: String!, $bimPath: String!, $databaseConnectionString: String!, $smtpServer: String!, $tabularConnectionString: String!,$drdlYamlServiceRestart: String!, $execute: String!, $archiveDb: String!, $taskInterval: String!, $databaseConnectionAesPassword: String!, $databaseConnectionUsername: String!, $parallelPartitions: String!) {createConfigurationDescription(name: $name, toEmailAddresses: $toEmailAddresses, fromEmailAddress: $fromEmailAddress, drdlYamlPath: $drdlYamlPath, environment: $environment, threads: $threads, cubeAdmins: $cubeAdmins, cubeUsers: $cubeUsers, bimPath: $bimPath, databaseConnectionString: $databaseConnectionString, smtpServer: $smtpServer, tabularConnectionString: $tabularConnectionString, drdlYamlServiceRestart: $drdlYamlServiceRestart, execute: $execute, archiveDb: $archiveDb, taskInterval: $taskInterval, databaseConnectionAesPassword: $databaseConnectionAesPassword, databaseConnectionUsername: $databaseConnectionUsername, parallelPartitions: $parallelPartitions)}`)
const updateMutation = useMutation(gql`mutation updateConfigurationDescription($_id: ID!, $name: String!, $toEmailAddresses: String!, $fromEmailAddress: String!, $drdlYamlPath: String!, $environment: String!, $threads: String!, $cubeAdmins: String!, $cubeUsers: String!, $bimPath: String!, $databaseConnectionString: String!, $smtpServer: String!, $tabularConnectionString: String!,$drdlYamlServiceRestart: String!, $execute: String!, $archiveDb: String!, $taskInterval: String!, $databaseConnectionAesPassword: String!, $databaseConnectionUsername: String!, $parallelPartitions: String!) {updateConfigurationDescription(_id: $_id, name: $name, toEmailAddresses: $toEmailAddresses, fromEmailAddress: $fromEmailAddress, drdlYamlPath: $drdlYamlPath, environment: $environment, threads: $threads, cubeAdmins: $cubeAdmins, cubeUsers: $cubeUsers, bimPath: $bimPath, databaseConnectionString: $databaseConnectionString, smtpServer: $smtpServer, tabularConnectionString: $tabularConnectionString, drdlYamlServiceRestart: $drdlYamlServiceRestart, execute: $execute, archiveDb: $archiveDb, taskInterval: $taskInterval, databaseConnectionAesPassword: $databaseConnectionAesPassword, databaseConnectionUsername: $databaseConnectionUsername, parallelPartitions: $parallelPartitions)}`)
