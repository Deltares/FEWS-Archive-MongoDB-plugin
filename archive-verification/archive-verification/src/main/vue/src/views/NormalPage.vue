...
async function create() {
  ...
  const result = await mutate(() => createMutation.mutate({ name: Name, collection: Collection, generateDays: GenerateDays, filters: JSON.parse(Filters) }))
...
async function update() {
  ...
  await mutate(() => updateMutation.mutate({ _id: _id, name: Name, collection: Collection, generateDays: GenerateDays, filters: JSON.parse(Filters) }))
}
