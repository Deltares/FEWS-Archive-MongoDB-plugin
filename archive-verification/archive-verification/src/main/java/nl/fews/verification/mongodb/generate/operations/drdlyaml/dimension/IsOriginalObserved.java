...
public final class IsOriginalObserved implements IExecute, IPredecessor {
	...
	public void execute(){
		...
		var template = String.join("\n", Mongo.findOne("template.DrdlYaml", new Document("Type", "Dimension").append("Name", "IsOriginalObserved")).getList("Template", String.class));
		...
		IO.writeString(Path.of(Settings.get("drdlYamlPath"), String.format("%s_IsOriginalObserved.drdl.yml", study)), template);
	}
