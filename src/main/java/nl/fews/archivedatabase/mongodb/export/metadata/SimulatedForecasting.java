...
public class SimulatedForecasting extends ExternalForecasting implements MetaData {
	 ...
	 */
	public SimulatedForecasting(String areaId, String sourceId, ArchiveDatabaseUnitConverter archiveDatabaseUnitConverter, ArchiveDatabaseTimeConverter archiveDatabaseTimeConverter){
