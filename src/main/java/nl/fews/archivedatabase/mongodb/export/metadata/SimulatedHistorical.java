...
public class SimulatedHistorical extends ExternalForecasting implements MetaData {
	 ...
	 */
	public SimulatedHistorical(String areaId, String sourceId, ArchiveDatabaseUnitConverter archiveDatabaseUnitConverter, ArchiveDatabaseTimeConverter archiveDatabaseTimeConverter){
