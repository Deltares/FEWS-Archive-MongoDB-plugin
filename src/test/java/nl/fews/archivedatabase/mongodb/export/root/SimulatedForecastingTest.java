...
public class SimulatedForecastingTest extends TestCase {
	...
	public void testGetRoot() {
		...
		nl.fews.archivedatabase.mongodb.export.timeseries.SimulatedForecasting timeseries = new nl.fews.archivedatabase.mongodb.export.timeseries.SimulatedForecasting(new TestUtil.ArchiveDatabaseUnitConverterTestImplementation(), new TestUtil.ArchiveDatabaseTimeConverterTestImplementation());
		List<Document> timeSeriesDocuments = timeseries.getTimeSeries(timeSeriesArray);
		Document runInfoDocument = new nl.fews.archivedatabase.mongodb.export.runinfo.SimulatedForecasting().getRunInfo();

		SimulatedForecasting simulatedForecasting = new SimulatedForecasting(new TestUtil.ArchiveDatabaseTimeConverterTestImplementation());
		Document document = simulatedForecasting.getRoot(timeSeriesHeader, timeSeriesDocuments, runInfoDocument);
