...
public class ExternalHistoricalTest extends TestCase {
	...
	public void testGetMetaData() {
		...
		ExternalHistorical externalHistorical = new ExternalHistorical("areaId", "sourceId", new TestUtil.ArchiveDatabaseUnitConverterTestImplementation(), new TestUtil.ArchiveDatabaseTimeConverterTestImplementation());
		Document document = externalHistorical.getMetaData(timeSeriesHeader);
