...
public class SimulatedHistoricalTest extends TestCase {
	...
	public void testGetRoot() {
		...
		nl.fews.archivedatabase.mongodb.export.timeseries.SimulatedHistorical timeseries = new nl.fews.archivedatabase.mongodb.export.timeseries.SimulatedHistorical(new TestUtil.ArchiveDatabaseUnitConverterTestImplementation(), new TestUtil.ArchiveDatabaseTimeConverterTestImplementation());
		List<Document> timeSeriesDocuments = timeseries.getTimeSeries(timeSeriesArray);
		Document runInfoDocument = new nl.fews.archivedatabase.mongodb.export.runinfo.SimulatedHistorical().getRunInfo();

		SimulatedHistorical simulatedHistorical = new SimulatedHistorical(new TestUtil.ArchiveDatabaseTimeConverterTestImplementation());
		Document document = simulatedHistorical.getRoot(timeSeriesHeader, timeSeriesDocuments, runInfoDocument);
