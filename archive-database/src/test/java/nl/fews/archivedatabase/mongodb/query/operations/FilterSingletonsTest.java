...
class FilterSingletonsTest {
	...
	void getFilters() throws Exception {
		...
		FilterSingletons filterSingletons = new FilterSingletons();
		Map<String, List<Object>> filters = filterSingletons.getFilters(
		...
		assertEquals(8, filters.get("moduleInstanceId").size());
