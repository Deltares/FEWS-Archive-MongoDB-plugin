...
//	}
	...
	@Test
	void test(){
		//String connectionString ="mongodb://fews_admin:AvjgHB1zgtBS*T#@chadwmongodb1.main.tva.gov:27017/FEWS_ARCHIVE?authSource=admin&tls=true";
		//String connectionString = "mongodb://chadwmongodb1.main.tva.gov:27017/FEWS_ARCHIVE?readPreference=primary&ssl=true&authSource=admin";
		String connectionString = "mongodb://emroush%40tva.gov:_$Emr68180211a@chadwmongodb1.main.tva.gov:27017/FEWS_ARCHIVE?authMechanism=PLAIN&readPreference=primary&ssl=true&authSource=$external";
