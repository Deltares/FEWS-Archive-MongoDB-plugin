...
class OpenArchiveToArchiveDatabaseBridgeMigratorTest {
	...
	void migrate() throws IOException {
		...
		if(testSettings != null && hostName.equalsIgnoreCase(testSettings.getString("hostName"))) {
			...
			archiveDatabase.setArchiveDatabaseUrl(testSettings.getString("archiveDatabaseConnectionString"));
			archiveDatabase.setUserNamePassword(testSettings.isNull("userName") ? "" : testSettings.getString("userName"), testSettings.isNull("password") ? "" : testSettings.getString("password"));

			OpenArchiveToArchiveDatabaseMigrator migrateDatabase = (OpenArchiveToArchiveDatabaseMigrator) archiveDatabase.getOpenArchiveToArchiveDatabaseMigrator();
			...
			LogUtils.addAppender(DbAppender.createAppender("databaseLogAppender", Settings.get("connectionString"), null));
