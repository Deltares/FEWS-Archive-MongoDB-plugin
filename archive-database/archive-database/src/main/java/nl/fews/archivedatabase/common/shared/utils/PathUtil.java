...
public final class PathUtil {
	...
	public static String toRelativePathString(File file, String baseDirectoryArchive){
		var fileNormalized = normalize(file).toString();
		var baseDirectoryArchiveNormalized = normalize(new File(baseDirectoryArchive)).toString();
		var relativePath = fileNormalized.replace(baseDirectoryArchiveNormalized, "").replace("\\", "/");
